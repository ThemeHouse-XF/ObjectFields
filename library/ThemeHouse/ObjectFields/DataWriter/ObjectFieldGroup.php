...
/**
* Data writer for object field groups.
*/
class ThemeHouse_ObjectFields_DataWriter_ObjectFieldGroup extends XenForo_DataWriter
{
	/**
	...
	protected function _getFields()
	{
		return array(
			'xf_object_field_group' => array(
				'field_group_id'        => array('type' => self::TYPE_UINT, 'autoIncrement' => true),
	...
	*/
	protected function _getExistingData($data)
	{
		...
		return array('xf_object_field_group' => $this->_getFieldModel()->getObjectFieldGroupById($id));
	}
	...
	*/
	...
	protected function _postSave()
	{
		...
		if ($titlePhrase !== null)
		{
			$this->_insertOrUpdateMasterPhrase(
				$this->_getTitlePhraseName($this->get('field_group_id')), $titlePhrase,
		...
		{
			$this->_getFieldModel()->rebuildObjectFieldMaterializedOrder();
		}

		$this->_getFieldModel()->rebuildObjectFieldCache();
	}
	...
	protected function _postDelete()
	{
		...
		$this->_db->update('xf_object_field', array('field_group_id' => 0), 'field_group_id = ' . $this->_db->quote($fieldGroupId));
	...
	{
		return $this->_getFieldModel()->getObjectFieldGroupTitlePhraseName($fieldGroupId);
	}

	/**
	 * @return XenForo_Model_ObjectField
	 */
